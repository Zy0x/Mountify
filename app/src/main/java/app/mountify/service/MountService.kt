...
class MountService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "mountify_service"
        const val NOTIFICATION_ID = 1001

        const val ACTION_MOUNT_ALL = "app.mountify.ACTION_MOUNT_ALL"
        const val ACTION_UNMOUNT_ALL = "app.mountify.ACTION_UNMOUNT_ALL"
