...
setlocal
echo ========================================================
echo  MountX - Android Studio Environment
echo ========================================================
...
:: Isolasi cache dan temporary MountX di Drive E:
set "LOCAL_CACHE=%MOUNTX_ROOT%\.build-cache"
...
echo Meluncurkan Android Studio untuk MountX...
start "" "%STUDIO_EXE%" "%MOUNTX_ROOT%"
